...
},  
{
  ...
  <p>
    Everything you need for encoding, security, formatting and productivity — completely free and running directly in your browser.
  </p>
...
>
  ...
  <div className="footer-grid">
    <div className="footer-brand">
      <h2>SecureToolHub</h2>
      <p>
        Fast, secure and browser-based developer tools for creators, students and developers.
      </p>
    </div>
  ...
  <div className="footer-bottom">
    <p>© 2025 SecureToolHub. Built for developers worldwide. create by Nedopulse consulting group</p>
